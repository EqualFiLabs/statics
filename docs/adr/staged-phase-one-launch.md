...
The complete plan contains 359 selectors. CI deploys Phase 1, advances the same Diamond through all
...
Phase 1 installs 26 facets and 181 selectors for:
...
Phase 2 adds 93 selectors for a cumulative 274 selectors across 38 facets. It installs:
...
Phase 3 adds 58 selectors for a cumulative 332 selectors across 43 facets. It adds Dollar custody,
...
Phase 4 adds 27 selectors for the final 359 selectors across 48 facets. It installs the remaining
...
Phase 1's deployed audit surface remains its 181 reachable selectors, facet paths and shared
