...
| --- | ---: | --- | --- |
| `arbitrary-send-erc20` | 6 | FALSE POSITIVE | Internal exact-transfer helpers receive authenticated or protocol-controlled payers or owners and validate the relevant debit, receipt, and ownership deltas. |
