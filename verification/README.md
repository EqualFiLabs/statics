...
| Bootstrap transfers exact backing, retains representative surplus above the fixed 100.1M vesting principal, clears bootstrap authority, and cannot repeat; Foundry covers arbitrary surplus and exact custody deltas | `StaticsTreasuryVesting` | Halmos plus Foundry | Pass |
