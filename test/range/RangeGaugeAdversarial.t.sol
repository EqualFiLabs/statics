...
contract RangeGaugeAdversarialTest is RangeGaugeLifecycleTestBase {
    ...
    function testProtectedContributionRejectsDustCompressionAndExpiryTopUpKeepsFinish() public {
        ...
        rangeGauge.fundPoolReward(poolId, staticsSlot, 100 ether, uint40(1 days), 0, 0);
        rangeGauge.fundPoolReward(poolId, staticsSlot, 1, 0, 0, 0);
        vm.stopPrank();
    ...
    function testFalseReturnRewardCannotCreateUnbackedLiability() public {
        ...
        vm.expectRevert();
        rangeGauge.fundPoolReward(poolId, malformedSlot, 100 ether, 0, 0, 0);
        vm.stopPrank();
