...
contract StaticsLaunchLiquidityHookHalmosTest is SymTest, Test {
    ...
    function check_afterSwapRoutesExactUnspecifiedFeeExactInputOneForZero(uint16 amount, uint16 feeBps) public {
        _checkAfterSwap(amount, feeBps, false, true);
    }

    function check_afterSwapRoutesExactUnspecifiedFeeExactOutputZeroForOne(uint16 amount, uint16 feeBps) public {
